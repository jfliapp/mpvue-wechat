<template>
  <div style="background: rgb(246, 246, 246);font-size: 15px;">
    ...
    <div style="margin-top:10px;height: 320px;background: white;font-size: 13px;padding: 10px;">
      <div style="display: flex;flex-direction: column;height: 100px;justify-content: space-around;border-bottom: 1px solid #ccc;padding-bottom: 10px">
